      ...
      <Modal open={openModal} onClose={() => setOpenModal(false)}>
        ...
        >
          ...
          <TextField
            ...
            type="number"
            value={newRow["750ML"]}
            onChange={(e) => setNewRow({ ...newRow, "750ML": e.target.value })}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            type="number"
            value={newRow["375ML"]}
            onChange={(e) => setNewRow({ ...newRow, "375ML": e.target.value })}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            type="number"
            value={newRow["180ML"]}
            onChange={(e) => setNewRow({ ...newRow, "180ML": e.target.value })}
            margin="normal"
          />
          <TextField
            fullWidth
            ...
            type="number"
            value={newRow["2LTR"]}
            onChange={(e) => setNewRow({ ...newRow, "2LTR": e.target.value })}
            margin="normal"
          />
